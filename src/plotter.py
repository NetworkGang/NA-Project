...
if not skip:
    ...
    lineargs = [
        [
            ...
            { 'label': f'Recovered' , 'color': '#b2b8be'}
        ]
    ]
    ...
    plot_models(
        ...
        vacs_deg,
        lineargs,
        title=f'Vaccinating top {n_vax} degree nodes - disjoint'
    )
    ...
    plot_models(
        ...
        vacs_bet,
        lineargs,
        title=f'Vaccinating top {n_vax} betweenness nodes - disjoint'
    )
#endregion
...
if not skip:
    ...
    plot_models(
        ...
        vacs_deg_bet,
        lineargs,
        title=f'Vaccinating top {n_vax} joint nodes'
    )
#endregion